...
namespace Test.Presentation.Controller.Summary;
...
{
    public FakeLogger<SummaryController> fakeLogger = null!;

    protected override void ConfigureWebHost(Microsoft.AspNetCore.Hosting.IWebHostBuilder builder)
    {
        builder.ConfigureServices(services =>
        {
            fakeLogger = new FakeLogger<SummaryController>();
            services.AddSingleton<ILogger<SummaryController>>(fakeLogger);

...
namespace Test.Presentation.Controller.Tag;
...
public class TagControllerTest
{
    ...
    public async Task AddTag_When_The_Same_TagName_is_Exist_Should_Return_BadRequest()
    {
        ...
        db.Tag.AddRange(new List<global::Domain.Entity.Tag>
        {
            new global::Domain.Entity.Tag
            {
                Name = "Test Tag",
                UserId = userId
            }
...
{
    public FakeLogger<TagController> fakeLogger = null!;

    protected override void ConfigureWebHost(Microsoft.AspNetCore.Hosting.IWebHostBuilder builder)
    {
        builder.ConfigureServices(services =>
        {
            fakeLogger = new FakeLogger<TagController>();
            services.AddSingleton<ILogger<TagController>>(fakeLogger);

...
public class CategoryService : ICategoryService
{
    ...
    public async Task AddCategoryAsync(Guid userId, Contract.Category category)
    {
        ...
        {
            Contract.CategoryType.EXPENSE => Domain.Entity.CategoryType.EXPENSE,
            Contract.CategoryType.INCOME => Domain.Entity.CategoryType.INCOME,
        ...
        var categoryEntity = new Domain.Entity.Category
        {
            Id = Guid.NewGuid(),
            Name = category.Name,
            Type = typeEntity,
    ...
    public async Task<List<Contract.Category>> GetAllCategoriesAsync(Guid userId)
    {
        ...
        return categories.Select(c => new Contract.Category
        {
            ...
            Type = c.Type switch
            {
                Domain.Entity.CategoryType.EXPENSE => Contract.CategoryType.EXPENSE,
                Domain.Entity.CategoryType.INCOME => Contract.CategoryType.INCOME,

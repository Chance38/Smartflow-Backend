...
public class RecordTemplateService : IRecordTemplateService
{
    ...
    public async Task AddRecordTemplateAsync(Guid userId, RecordTemplate temp)
    {
        ...
        {
            Application.Contract.CategoryType.EXPENSE => Domain.Entity.CategoryType.EXPENSE,
            Application.Contract.CategoryType.INCOME => Domain.Entity.CategoryType.INCOME,
        ...
        var recordTemplate = new Domain.Entity.RecordTemplate
        {
            Id = Guid.NewGuid(),
            Name = temp.Name,
    ...
    public async Task<List<RecordTemplate>> GetAllRecordTemplatesAsync(Guid userId)
    {
        ...
        return temps.Select(t => new RecordTemplate
        {
            Name = t.Name,
            CategoryName = t.CategoryName,
            CategoryType = t.CategoryType switch
            {
                Domain.Entity.CategoryType.EXPENSE => Application.Contract.CategoryType.EXPENSE,
                Domain.Entity.CategoryType.INCOME => Application.Contract.CategoryType.INCOME,
